 ...
 */
	...
	public class Disassembler {
         ...
         */
		private void WriteR(char leftbracket, Register register, char rightbracket) {
         ...
         */
		private void BlankN() { Console.Write("      "); }
         ...
         *          the integer to write.
         */
		private void WriteOperand(int operand) { Console.Write(operand); }
         ...
         */
		private void DisassembleProgram(int codeTop) {
			for(short addr = Machine.CodeBase; addr < codeTop; addr++) {
		...
		public static void Main(string[] args) {
			...
			int codeTop = disassembler.LoadObjectProgram(objectName);
