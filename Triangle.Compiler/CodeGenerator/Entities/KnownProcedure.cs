...
namespace Triangle.Compiler.CodeGenerator.Entities {
	public class KnownProcedure : RuntimeEntity, IProcedureEntity {
		private readonly ObjectAddress _address;

		public KnownProcedure(int size, int level, int displacement) : base(size) { _address = new ObjectAddress(level, displacement); }
